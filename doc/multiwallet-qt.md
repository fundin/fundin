...
In order to support loading of multiple wallets in fundin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fundin.cpp.
...
Changes to fundin.cpp
----------------------
fundin.cpp is the entry point into fundin-qt, and as such, will require some minor modifications to provide hooks for
