...
The following new options are available for fundind and fundin-qt:
...
Sample initialization flow from _fundin-qt_ console (this needs to be done only once to set up the association):

 - Have KeePass running with an open database
 - Start _fundin-qt_
 - Open console
 - Type "_keepass init_" in fundin-qt console
 - Keepass pops up and asks for an association id, fill that in, for example, "_mydrkwallet_"
 - You should get a response like this "_Association successful. Id: mydrkwalletfundin - Key: AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=_"
 - Edit _fundin.conf_ and fill in these values
```
keepass=1
