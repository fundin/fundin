...
This mechanism has been integrated into Bitcore-Node-FUNDin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fundin/insight-api-fundin#web-socket-api](https://github.com/fundin/insight-api-fundin#web-socket-api) 
* API: [https://github.com/fundin/insight-api-fundin#swifttx-transactions](https://github.com/fundin/insight-api-fundin#swifttx-transactions) 
...
By default, the Fundin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fundin Core daemon:
