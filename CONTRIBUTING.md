Contributing to Fundin Core
============================

The Fundin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Fundin Core project, and is not to be
confused with overall Fundin Network Protocol consensus changes.

Whether a pull request is merged into Fundin Core rests with the project merge
...
Patches that change Fundin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fundin consensus, it must have been
...
The project leader is the release manager for each Fundin Core release.
