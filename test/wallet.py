...
#   c) node1 mines 32 blocks, so now node 0 has 60001fdn, node 1 has 4250fdn, node2 has none.
#   d) node0 sends 601 fdn to node2, in two transactions (301 fdn, then 300 fdn).
