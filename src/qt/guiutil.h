...
/** Utility functions used by the Fundin Qt UI.
 */
namespace GUIUtil
{
...
// Render Fundin addresses in monospace font
...
// Parse "fundin:" URI into recipient object, return true on successful parsing
