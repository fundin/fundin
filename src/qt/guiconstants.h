...
/* AskPassfdnaseDialog -- Maximum passfdnase length */
static const int MAX_PASSFDNASE_SIZE = 1024;

/* Fundin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Fundin"
#define QAPP_ORG_DOMAIN "fundin.org"
#define QAPP_APP_NAME_DEFAULT "Fundin-Qt"
#define QAPP_APP_NAME_TESTNET "Fundin-Qt-testnet"
