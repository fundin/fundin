 ...
 */
    ...
    typeWidget->addItem(tr("Received Fdn from zFdn"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zFdn"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zFdn));
