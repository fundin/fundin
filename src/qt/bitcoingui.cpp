...
BitcoinGUI::BitcoinGUI(const NetworkStyle* networkStyle, QWidget* parent) : QMainWindow(parent),
                                                                            ...
                                                                            spinnerFrame(0)
{
    QFontDatabase::addApplicationFont(":/fonts/Brando-Sans-Bold");
    QFontDatabase::addApplicationFont(":/fonts/Brando-Sans-SemiBold");
    QFontDatabase::addApplicationFont(":/fonts/Brando-Sans-Regular");
    QFontDatabase::addApplicationFont(":/fonts/Brando-Sans-Light");
    ...
    QString windowTitle = tr("Fundin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fundin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fundin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFDN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fundin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fundin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fundin"));
    ...
    changePassfdnaseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passfdnase..."), this);
    changePassfdnaseAction->setStatusTip(tr("Change the passfdnase used for wallet encryption"));
    unlockWalletAction = new QAction(tr("&Unlock Wallet..."), this);
    unlockWalletAction->setToolTip(tr("Unlock wallet"));
    lockWalletAction = new QAction(tr("&Lock Wallet"), this);
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your Fundin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fundin addresses"));
    bip38ToolAction = new QAction(QIcon(":/icons/key"), tr("&BIP38 tool"), this);
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passfdnase"));
    ...
    openAction->setStatusTip(tr("Open a Fundin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fundin Core help message to get a list with possible Fundin command-line options"));
    ...
    if (walletFrame) {
        ...
        connect(changePassfdnaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePassfdnase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePassfdnaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePassfdnaseAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fundin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fundin network", "", count));
}
...
{
    QString strTitle = tr("Fundin Core"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePassfdnaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePassfdnaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
