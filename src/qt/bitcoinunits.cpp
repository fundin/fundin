...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(FDN);
    unitlist.append(mFDN);
    unitlist.append(uFDN);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case FDN:
        return QString("fundin");
    case mFDN:
        return QString("mfundin");
    case uFDN:
        return QString::fromUtf8("ufundin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case FDN:
            return QString("tFDN");
        case mFDN:
            return QString("mtFDN");
        case uFDN:
            return QString::fromUtf8("μtFDN");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case FDN:
            return QString("FDN");
        case mFDN:
            return QString("Milli-FDN (1 / 1" THIN_SP_UTF8 "000)");
        case uFDN:
            return QString("Micro-FDN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case FDN:
            return QString("TestFDNs");
        case mFDN:
            return QString("Milli-TestFDN (1 / 1" THIN_SP_UTF8 "000)");
        case uFDN:
            return QString("Micro-TestFDN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
