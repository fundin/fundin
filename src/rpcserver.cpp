...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fundin features */
        {"fundin", "masternode", &masternode, true, true, false},
        {"fundin", "listmasternodes", &listmasternodes, true, true, false},
        {"fundin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fundin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fundin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fundin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fundin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fundin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fundin", "masternodedebug", &masternodedebug, true, true, false},
        {"fundin", "startmasternode", &startmasternode, true, true, false},
        {"fundin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fundin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fundin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fundin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fundin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fundin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fundin", "mnbudget", &mnbudget, true, true, false},
        {"fundin", "preparebudget", &preparebudget, true, true, false},
        {"fundin", "submitbudget", &submitbudget, true, true, false},
        {"fundin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fundin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fundin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fundin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fundin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fundin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fundin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fundin", "checkbudgets", &checkbudgets, true, true, false},
        {"fundin", "mnsync", &mnsync, true, true, false},
        {"fundin", "spork", &spork, true, true, false},
        {"fundin", "getpoolinfo", &getpoolinfo, true, true, false},
        {"fundin", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"wallet", "walletpassfdnasechange", &walletpassfdnasechange, true, false, true},
        {"wallet", "walletpassfdnase", &walletpassfdnase, true, false, true},
        ...
        {"zerocoin", "getzfdnseed", &getzfdnseed, false, false, true},
        {"zerocoin", "setzfdnseed", &setzfdnseed, false, false, true}
...
{
    return "> fundin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7077/\n";
}
