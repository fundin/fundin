...
extern std::string HelpRequiringPassfdnase();
...
extern UniValue walletpassfdnase(const UniValue& params, bool fHelp);
extern UniValue walletpassfdnasechange(const UniValue& params, bool fHelp);
...
extern UniValue setzfdnseed(const UniValue& params, bool fHelp);
extern UniValue getzfdnseed(const UniValue& params, bool fHelp);
