...
FORMS += src/qt/forms/addressbookpage.ui \
         src/qt/forms/askpassfdnasedialog.ui \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/qt/askpassfdnasedialog.cpp \
...
RESOURCES += src/qt/fundin.qrc src/qt/fundin_locale.qrc

TRANSLATIONS += src/qt/locale/fundin_bg.ts \
                src/qt/locale/fundin_de.ts \
                src/qt/locale/fundin_en.ts \
                src/qt/locale/fundin_es.ts \
                src/qt/locale/fundin_fi.ts \
                src/qt/locale/fundin_fr.ts \
                src/qt/locale/fundin_it.ts \
                src/qt/locale/fundin_ja.ts \
                src/qt/locale/fundin_pl.ts \
                src/qt/locale/fundin_pt.ts \
                src/qt/locale/fundin_ru.ts \
                src/qt/locale/fundin_sk.ts \
                src/qt/locale/fundin_sv.ts \
                src/qt/locale/fundin_vi.ts \
                src/qt/locale/fundin_zh_CN.ts \
                src/qt/locale/fundin_zh_TW.ts
